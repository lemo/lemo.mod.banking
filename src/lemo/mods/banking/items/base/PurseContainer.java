...
public class PurseContainer extends Container {
	...
	public PurseContainer(EntityPlayer par1Player,
		...
		// }
		this.addSlotToContainer(new PurseSlot(this.inventory, i++, 80, 8));
		this.addSlotToContainer(new PurseSlot(this.inventory, i++, 80 + 18, 8));
		this.addSlotToContainer(new PurseSlot(this.inventory, i++, 80 + 18 * 2,
				8));
