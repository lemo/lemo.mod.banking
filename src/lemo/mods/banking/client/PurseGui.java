...
public class PurseGui extends GuiContainer {
	...
	private static final ResourceLocation iconLocation = new ResourceLocation(
			Banking.modid, "textures/gui/purse.png");

	/** The inventory to render on screen */
	private final PurseInventory inventory;

	public PurseGui(PurseContainer container) {
		super(container);
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		String s = this.inventory.isInvNameLocalized() ? this.inventory
				.getInvName() : I18n.getString(this.inventory.getInvName());
		this.fontRenderer.drawString(s,
				this.xSize / 2 - this.fontRenderer.getStringWidth(s) / 2, 0,
				4210752);
		this.fontRenderer.drawString(I18n.getString("container.inventory"), 26,
	...
	// par5EntityLivingBase.prevRotationYawHead =
	// par5EntityLivingBase.rotationYaw;
